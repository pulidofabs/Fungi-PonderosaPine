...
RawOtu<-read.csv("QiimeOutputs/FunGuild/Fungal-table-with-taxonomy.guilds_editted.csv", row.names = 1, check.names = FALSE) #Raw OTU table w/o singletons, contaminated sample removed
dim(RawOtu)#8585  223


#Subset data to maintain only those taxa that are classified as Ectomycorrhizal 
RawEcM<-RawOtu[which(RawOtu$Guild =="Ectomycorrhizal"),]
dim(RawEcM)#889 x 223

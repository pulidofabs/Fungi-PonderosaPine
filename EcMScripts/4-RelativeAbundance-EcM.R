...
write.csv(RelGenTrt1, "Analysis/RelativeAbundance/Ectomycorrhizal/Tables/RelativeAbundaceTrt1.csv")
write.csv(RelGenTsf1B, "Analysis/RelativeAbundance/Ectomycorrhizal/Tables/RelativeAbundaceTimeSinceFire-Burned1.csv")
write.csv(RelGenTsf1Un, "Analysis/RelativeAbundance/Ectomycorrhizal/Tables/RelativeAbundaceTimeSinceFire-Unburned1.csv")
...
Trt<-c("< 2% abund."="#9a9696","Cenococcum"="#470000","Chromelosporium"="#8e3600",
      ...
      "Inocybe"="#382752","Lyophyllum"="#534463","Peziza"="#71637a","Piloderma"="#908894",
      "Pustularia"="#c1b7d0","Rhizopogon"="#f2efd3","Russula"="#e1f0fd",
...
Burn<-c("< 2% abund."="#9a9696","Cenococcum"="#470000","Chromelosporium"="#8e3600",
        ...
        "Inocybe"="#382752","Lyophyllum"="#534463","Morchella"="#9e6c6c",
        "Peziza"="#71637a","Pustularia"="#c1b7d0","Rhizopogon"="#f2efd3",
...
Un<-c("< 2% abund."="#9a9696","Amphinema"="#9e0022","Cortinarius"="#c25715",
      ...
      "Inocybe"="#382752","Piloderma"="#908894","Rhizopogon"="#f2efd3",
...
#Export Graphs--------------------------------------------------------------------------------------------
pdf("Analysis/RelativeAbundance/Ectomycorrhizal/Graphs/Rel-Abund-Trt.pdf", height=5, width=6.5)
AbunTrt
dev.off()

pdf("Analysis/RelativeAbundance/Ectomycorrhizal/Graphs/Rel-Abund-TSF-Burned1.pdf", height=5, width=6.5)
AbunB
dev.off()

pdf("Analysis/RelativeAbundance/Ectomycorrhizal/Graphs/Rel-Abund-TSF-Unburned1.pdf", height=5, width=6.5)
AbunUn
dev.off()


#Export Panels--------------------------------------------------------------------------------------------
pdf("Analysis/RelativeAbundance/Ectomycorrhizal/Graphs/TSF-Burned-Unburned1.pdf", height=10, width=7)
GenTSF
dev.off()


pdf("Analysis/RelativeAbundance/Ectomycorrhizal/Graphs/TSF-Burned-Unburned2.pdf", height=6, width=14)
GenTSF2
dev.off()
...
GenTSF1<-ggarrange(AbunTrt,AbunTrtSap,ncol=1, nrow=2, labels= c("a EcM","b Saprobes"), 
                   font.label = list(size = 16,face = "bold", color ="black"),
...
pdf("Analysis/RelativeAbundance/Panels/Rel-Abund-Treatment.pdf", height=10, width=6)
GenTSF1
dev.off()
...
pdf("Analysis/RelativeAbundance/Panels/Rel-Abund-TSF-ALL.pdf", height=12, width=14)
GenTSF3
dev.off()

pdf("Analysis/RelativeAbundance/Panels/Rel-Abund-TSF-Burned.pdf", height=12, width=7)
GenTSF2
dev.off()

#Last time code was ran............ 9-15-2020
...
Metadata<-read_tsv("Metadata/Metadata-PIPO-NC.tsv")#Rare metadata
Table<-read_qza("Qiime/DADA2/Fungal-Table-dada2-NS.qza", tmp = "C:/tmp")#Need unrarefied table
...
#--EXPORT GRAPS ----------------------------------------------------------------------------------
#*********************************************************************************************----
pdf("Analysis/Diversity/Fungi/Graphs/RarefactionCurves-Treatment-Fun.pdf", height=6, width=10.5)
Trt
dev.off()

pdf("Analysis/Diversity/Fungi/Graphs/RarefactionCurves-Site-Fun.pdf", height=10, width=10)
Site
dev.off()

pdf("Analysis/Diversity/Fungi/Graphs/RarefactionCurves-TSF-Fun.pdf", height=10, width=10)
TSFplot
dev.off()
...
#
pdf("Analysis/Diversity/3Plots-RarefactionCurve-Trt.pdf", height=12, width=10, onefile=FALSE)
ggarrange(Trt,TrtEcM,TrtSap, ncol=1, nrow=3, common.legend = TRUE, 
          labels = c("a Total Fungi","b EcM", "c Saprobes"),
          legend="bottom", hjust = c(-.3, .1),
          align="hv",font.label = list(size=16,face="bold"))
dev.off()

pdf("Analysis/Diversity/2Plots-RarefactionCurve-TSF-EcM-Sap.pdf", height=12, width=10, onefile=FALSE)

...
#To rerun graphs do not need to run phyloseq- just load the saved files..........................
#EXPORT RELATIVE ABUNDANCE TABLES----------------------------------------------------------------------------------------------------
RelGenTrt1<-read.csv("Analysis/RelativeAbundance/Fungi/Tables/DesStats/RelativeAbundaceTrt-DesStats-Data.csv")
RelGenTsf1B<-read.csv("Analysis/RelativeAbundance/Fungi/Tables/DeStats/RelativeAbundace-TSF-Burn-DesStats-Data.csv")
RelGenTsf1Un<-read.csv("Analysis/RelativeAbundance/Fungi/Tables/DesStats/RelativeAbundace-TSF-Unburn-DesStats-Data.csv")
...
physeqBurn<-subset_samples(physeq,Treatment=="Burned");physeqBurn #104x7952 taxa 
sample_names(physeqBurn) 

physeqUnburn<-subset_samples(physeq,Treatment=="Unburned");physeqUnburn #106 x 7952
...
#EXPORT FILES ....................................................................................................
dir.create("Analysis/RelativeAbundance/Fungi/Tables/DesStats", recursive = TRUE)
write.csv(RelGenTrt1, "Analysis/RelativeAbundance/Fungi/Tables/DesStats/RelativeAbundaceTrt-DesStats-Data.csv")
write.csv(RelGenTsf1B, "Analysis/RelativeAbundance/Fungi/Tables/DeStats/RelativeAbundace-TSF-Burn-DesStats-Data.csv")
write.csv(RelGenTsf1Un, "Analysis/RelativeAbundance/Fungi/Tables/DesStats/RelativeAbundace-TSF-Unburn-DesStats-Data.csv")
...
dir.create("Analysis/RelativeAbundance/Fungi/Tables/DesStats")

write.csv(TrtDesStats, "Analysis/RelativeAbundance/Fungi/Tables/DesStats/TRT-DescripStats.csv")
write.csv(TSFDesStatsB, "Analysis/RelativeAbundance/Fungi/Tables/DesStats/TSF-Burned-DescripStats.csv")
write.csv(TSFDesStatsUn, "Analysis/RelativeAbundance/Fungi/Tables/DesStats/TSF-Unburned-DescripStats.csv")
...
#Export tables................................................................................................
dir.create("Analysis/RelativeAbundance/Fungi/Tables/PercentChange")

write.csv(TrtPerChg,"Analysis/RelativeAbundance/Fungi/Tables/PercentChange/TRT-PerChange.csv")
write.csv(TsfPerChgB,"Analysis/RelativeAbundance/Fungi/Tables/PercentChange/TSF-Burned-PerChange.csv")
write.csv(TsfPerChgUn,"Analysis/RelativeAbundance/Fungi/Tables/PercentChange/TSF-Unburned-PerChange.csv")
